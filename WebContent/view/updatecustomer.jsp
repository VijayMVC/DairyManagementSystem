...
<div class="col-sm-9"  style="height: 500px; color: black;">
     <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title">Customer Update Form</div>
            </div>  
            <div class="panel-body" >
                <form method="post" action="./updatecustomer.dairy">
                 ...
                 <input type="hidden" name="cid" value="${cus.cid}"/>
                      ...
                      <div id="div_id_username" class="form-group required">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md  textinput textInput form-control" id="id_username" maxlength="30" name="cusfname" value="${cus.cusfname}" placeholder="Choose your First Name" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div>
                       ...
                       <div id="div_id_username" class="form-group required">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md  textinput textInput form-control" id="id_username" maxlength="30" name="cuslname" value="${cus.cuslname}" placeholder="Choose your Last Name" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div>
                        <div id="div_id_email" class="form-group required">
                            <label for="id_email" class="control-label col-md-4  requiredField"> E-mail:<span class="asteriskField">*</span> </label>
                            <div class="controls col-md-8 ">
                                <input class="input-md emailinput form-control" id="id_email" name="cusemail" value="${cus.cusemail}" placeholder="Your current email address" style="margin-bottom: 10px" type="email" />
                            </div>     
                        </div>
                        ...
                        <div id="div_id_number" class="form-group required">
                             ...
                             <div class="controls col-md-8 ">
                                 <input class="input-md textinput textInput form-control" id="id_number" name="cuscontact" value="${cus.cuscontact}" placeholder="provide your number" style="margin-bottom: 10px" type="text" />
                            </div> 
                        </div> 
                        <div id="div_id_location" class="form-group required">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md textinput textInput form-control" id="id_location" name="cuslocation" value="${cus.cuslocation}" placeholder="Your Village and City" style="margin-bottom: 10px" type="text" />
                            </div> 
                        </div>
                       ...
                       <div id="div_id_location" class="form-group required">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md textinput textInput form-control" id="id_location" name="cusorgname" value="${cus.cusorgname}" placeholder="Your Oragnization Name" style="margin-bottom: 10px" type="text" />
                            </div> 
                        </div>
