                       ...
                       <div id="div_id_username" class="form-group required">
                        ...
                        <div id="div_id_location" class="form-group required">
                            ...
                            <div class="controls col-md-8 ">
                              ...
                              <div id="div_id_location" class="form-group required">
                            <label for="id_location" class="control-label col-md-4  requiredField">Category:<span class="asteriskField">*</span> </label>
                            <div class="controls col-md-8 ">
                                <input class="input-md textinput textInput form-control" id="id_location" name="pdcategory" placeholder="Enter category" style="margin-bottom: 10px" type="text" />
                            </div> 
                        </div>
